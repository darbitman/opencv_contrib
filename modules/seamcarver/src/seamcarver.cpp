...
void cv::SeamCarver::findAndRemoveVerticalSeams(int32_t numSeams, const cv::Mat& img,
...
void cv::SeamCarver::findVerticalSeams(int32_t numSeams, vector<vector<double>>& pixelEnergy,
